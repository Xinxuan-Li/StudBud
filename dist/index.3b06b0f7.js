...
})({"7z9kH":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
var _createNewProjectJs = require("./components/createNewProject.js");
var _projectObjJs = require("./components/projectObj.js");
...
allProjects.addEventListener("submit", function(event) {
    ...
    if (project) addProject(project, pDueDate, pStatus);
});
...
},{"./components/projectObj.js":"fxQkq","./components/createNewProject.js":"jVaoq"}],"fxQkq":[function(require,module,exports) {
class ProjectObj {
    constructor(projName, duedate, projStatus){
        this.projName = projName;
        this.duedate = duedate;
...
},{}],"jVaoq":[function(require,module,exports) {
var projectList = document.getElementById('projectList');
const allProjects = document.getElementById('allProjects');
var projectNameInput = document.getElementById('projectName');
var statusInput = document.getElementById('status');
...
},{}]},["7z9kH","2OD7o"], "2OD7o", "parcelRequire60da")
